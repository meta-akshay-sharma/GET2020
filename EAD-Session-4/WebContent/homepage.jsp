...
<body>
	...
	<div class="tab">
		<button class="tablinks" onclick="openCity(event, 'London')"
			id="defaultOpen">Employee Profile</button>
				...
				<div class="col">
					...
					<%
						try {
							...
							Connection con = DriverManager.getConnection(
									"jdbc:mysql://localhost:3306/mydb", "root", "akshay");
							PreparedStatement ps = con
									.prepareStatement("select * from register where empid=?");
							ps.setInt(1, id);
					...
					<table>
						...
						<tr>
							...
							<td"WebContent/homepage.jsp"><%=rs.getString("emporganisation")%></td>
						</tr>
						<%
							}
					...
					<%
						try {
							...
							Connection con = DriverManager.getConnection(
									"jdbc:mysql://localhost:3306/mydb", "root", "akshay");
							PreparedStatement ps = con
									.prepareStatement("select * from vehicleregister where idvehicleregister=?");
							ps.setInt(1, id);
							ResultSet rs = ps.executeQuery();
					%>
					...
					<%
						try {
							...
							Connection con = DriverManager.getConnection(
									"jdbc:mysql://localhost:3306/mydb", "root", "akshay");
							PreparedStatement ps = con
									.prepareStatement("select * from vehicleplan where idvehicleplan=?");
							ps.setInt(1, id);
							ResultSet rs = ps.executeQuery();
					%>
					...
					<%
						try {
							...
							Connection con = DriverManager.getConnection(
									"jdbc:mysql://localhost:3306/mydb", "root", "akshay");
							PreparedStatement ps = con
									.prepareStatement("select emporganisation from register where empid=?");
							ps.setInt(1, id);
							ResultSet rs = ps.executeQuery();
							rs.next();
